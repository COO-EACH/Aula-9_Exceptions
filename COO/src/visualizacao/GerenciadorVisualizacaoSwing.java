...
public class GerenciadorVisualizacaoSwing extends JFrame {
	...
	private JTextField fieldQuantidadeDeExemplaresTotalCD = new JTextField();
	private JTextField fieldQuantidadeDeExemplaresEmprestadosCD = new JTextField();
	private JTextField fieldQuantidadeDeExemplaresDisponiveisCD = new JTextField();
	...
	private JTextField fieldQuantidadeDeExemplaresLivro = new JTextField();
	...
	private void inicializaComponentes() {
		...
		adicionaCamposComRotulos(painelCadastrarLivro, new String[] {
				"Título: ", "Autores: ", "Código:" , "Qtd de Exemplares"}, new JTextField[] {
				fieldTituloLivro, fieldAutoresLivro, fieldCodigoLivro, fieldQuantidadeDeExemplaresTotalCD });
		...
		// --- painel lista CD ---
				adicionaPainel(painelListaCD, "CD Cadastrados", new Color(255,
						255, 154));
				adicionaTabela(painelListaCD, tabelaLivros);
		// ---------------------------
	...
	public void cadastrarCDActionPerformed(ActionEvent evt) {
		...
		try {
			codigo = validador.validaFormataInteiro(fieldCodigoCD.getText(), "Código"); 
			nome = validador.validaFormataCaixaAlta(fieldNomeCD.getText(), 10, "Nome"); 
			album = validador.validaFormataCaixaAlta(fieldAlbumCD.getText(), 10, "Album"); 
			artista = validador.validaFormataCaixaAlta(fieldArtistaCD.getText(), 10, "Artista"); 
			qtdExemplares = validador.validaFormataCaixaAlta(fieldQtdExemplaresCD.getText(), 10, "QtdExemplares"); 
					
			gerenciadorRegrasNegocio.cadastraCD(nome, codigo);
			JOptionPane.showMessageDialog(this,
					"Usuário cadastrado com sucesso.");
